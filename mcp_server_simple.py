            ...
            return ListToolsResult(
                tools=[
                    ...
                    Tool(
                        ...
                        description="生成週報（支援 HTML、CSV、Markdown 格式）",
                        inputSchema={
                            "type": "object",
                            "properties": {
                                "format": {
                                    "type": "string",
                                    "description": "報告格式（html、csv、markdown、all）",
...
async def main():
    ...
    if not MCP_AVAILABLE:
        print("❌ MCP 套件未安裝，無法啟動 MCP 伺服器")
        print("💡 請執行以下命令安裝 MCP：")
        print("   pip install mcp")
        print("   或使用簡化版本：python example_usage_simple.py")
        return
